...
//        protected Dictionary<Guid, ProjectView> Samples;

//        protected override void Given()
//        {
//            Samples = new Dictionary<Guid, ProjectView>();
//            var writer = MockRepository.GenerateMock<IProjectionWriter<ProjectView>>();
//            writer.Stub(x => x.Add(Arg<Guid>.Is.Anything, Arg<ProjectView>.Is.Anything))
//                .WhenCalled(mi => Samples[(Guid)mi.Arguments[0]] = (ProjectView)mi.Arguments[1])
//                .Return(Task.Delay(0));
//            writer.Stub(x => x.Update(Arg<Guid>.Is.Anything, Arg<Action<ProjectView>>.Is.Anything))
//                .WhenCalled(mi =>
//                {
//                    var sample = Samples[(Guid) mi.Arguments[0]];
//                    ((Action<ProjectView>) mi.Arguments[1])(sample);
//                })
//                .Return(Task.Delay(0));
